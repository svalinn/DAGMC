...
if (Geant4_CMAKE_CONFIG_VERSION)
  ...
  set(Geant_4_VERSION_COMPATIBLE ${PACKAGE_VERSION_COMPATIBLE})
  set(Geant_4_VERSION_EXACT ${PACKAGE_VERSION_EXACT})
else ()
...
if (Geant_4_VERSION_COMPATIBLE AND Geant4_INCLUDE_DIRS AND (Geant4_LIBRARIES_SHARED OR NOT BUILD_SHARED_LIBS) AND
