...
class dagmcMetaData {
 public:
  ...
  std::string get_volume_property(const std::string &property,
                                  moab::EntityHandle vol);
  std::string get_volume_property(const std::string &property, int vol,
                                  bool idx = true);

  // get a given property on a surface
  std::string get_surface_property(const std::string &property,
                                   moab::EntityHandle surface);
  std::string get_surface_property(const std::string &property, int surface,
                                   bool idx = true);

  std::vector<std::string> unpack_string(const std::string& to_unpack,
  ...
  std::string return_property(const std::string& property_string,
                              const std::string& property,
                              const std::string& delimiter = ":",
                              bool chopped = true);

  // test to see if string is an int
  bool try_to_make_int(const std::string& value);
 ...
 private:
  ...
  std::set<std::string> set_remove_rich(
