...
try:
    ...
    raise ImportError(
        "The PyTAPS dependency 'iMesh/iBase' could not be imported!")
...
try:
    ...
    raise ImportError(
        "The PyNE dependency 'Material/MaterialLibrary' could not be imported!")
...
defining 
-f  : the .h5m file path
-d  : nuc_data.h5 'the PyNE material library' path
